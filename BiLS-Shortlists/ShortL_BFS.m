...
fprintf('\n Open file outputs outputs\\exxamples\\example1.txt to see all stable matchings\n');
DisplayMatchingSet(menShortlist,womenShortlist,stableMatchingSet,parentLinks,'..\outputs\examples\example1.txt');
end
%---------------------------------------------------------------