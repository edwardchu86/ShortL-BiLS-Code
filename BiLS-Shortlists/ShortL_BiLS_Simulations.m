function ShortL_BiLS_Simulations()
clc;
clear all;
close all;
for i = 425
    ...
    for j = i:i+9
        ...
        load(filename1);
        load(filename2);
        [f_time,f_cost] = ShortL_BiLS(menList,womenList);
    ...
    %save to file
    filename_out = ['..\outputs\test1\ShortL_BiLS_eg',num2str(i),'.mat'];
    save(filename_out,'f_arr_time','f_arr_cost');
end
end
%============================================================
function [f_time,f_cost] = ShortL_BiLS(menList,womenList)
